...
export type ScannedRoutes = {
  ALL: {
    ...
    'workspace.delete_video': { paramsTuple: [ParamValue]; params: {'id': ParamValue} }
    ...
    'workspace.render_final_video_editing_job': { paramsTuple: [ParamValue]; params: {'id': ParamValue} }
